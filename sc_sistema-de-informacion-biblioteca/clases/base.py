...
class Base:
    def __init__(self):
        self.LibroManager = LibroManager()
        self.ArticuloManager = ArticuloCientificoManager()
        self.AutorManager = AutorManager()
        self.TesisManager = TesisManager()
        self.LectorManager = LectorManager()
